...
<p className='navbar_main_subhead'>LEAD GENERATION <span className='navbar_main_subheadcolor'>SOLUTIONS</span></p>
...
<div className='mt-3'>
<Link to='/list-service'><button className='discover_btn'>DISCOVER MORE</button></Link> &nbsp;
<button className='callnow_btn'><a className='call_btn' href='tel:+1 (959) 500-5594'>Call now<img src={arrownav} alt='arrownav'/></a></button>
</div>
</div>
