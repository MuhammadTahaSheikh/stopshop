...
function Footer() {
  ...
  <div class="col-xl-5 col-lg-5 upper_main pl-5">Get your Free
  Business
  Consultation</div>
  ...
  <p className='uperfotter_phone1'>info@stopshoprei.com</p>
  	 	...
  	 	<div class="row">
  	 		...
  	 		<p className='sub_contact_detail'>StopShopREI is committed to staying ahead of the curve, continuously adapting to the ever-evolving real estate landscape. We envision a future where every real estate has access to the tools and knowledge they need to succeed in a competitive market.</p>
         <div class="social-links">
  	 		...
  	 		<div class="col-xl-3 col-md-6 footer-col">
  	 			...
  	 			<ul className='ql'>
  	 				<li> <Link to='/about-us' className='contact_ushref'><a href="#"><span><img className='pr-2 ql_links' src={arrow} alt='arrow'/></span>About Us</a></Link></li>
  	 				<li><a href="/#id_feedback"><span><img className='pr-2 ql_links' src={arrow} alt='arrow'/></span>Client Feedback</a></li>
  	 				<li><a href="/#id_questions"><span><img className='pr-2 ql_links' src={arrow} alt='arrow'/></span>Our Services</a></li>
             <li><Link to='/contact-us' className='contact_ushref'><a href="/contact-us"><span><img className='pr-2 ql_links' src={arrow} alt='arrow'/></span>Contact Us</a></Link></li>
  	 			</ul>
  	 		</div>
  	 		<div class="col-xl-3 col-md-6 footer-col">
                   ...
                   <Link to={`/blogs/${data.id}/${slugify(data.title, { lower: true })}`}>
                     <div className="row">
                       ...
                       <div className="col-lg-8 col-md-8 col-8">
                         ...
                         <p className="heading_related_post1">{data?.title}</p>
                       </div>                   
                     </div>                  
                   </Link>             
                 </div>   
         ...
         <h2 className='sub_contact'>Office Location</h2>
           ...
           <div class="p-2 sub_contact_detail">16 Stonefield Drive, Waterbury Connecticut, USA</div>
     ...
     <div className='footer_last p-3'>© 2023 StopShopRei. All Rights Reserved.</div>
