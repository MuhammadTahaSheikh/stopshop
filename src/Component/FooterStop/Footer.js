          ...
          <div class="row">
            <div class="col-xl-3 col-md-6 footer-col">
              ...
              <div className="pt-3">
                <p>
                  {" "}
                  <h4 className="footer_heading">Subscribe to News Letter</h4>
                </p>
                <form>
                  <label>Email*</label>
                  <div>
                    <input type="email" required className="input_subscription" />
                  </div>
                </form>

                <button className="input_submit mt-3 mb-3">Submit</button>
              </div>
            </div>
            <div class="col-xl-3 col-md-6 footer-col">
            ...
            <div class="col-xl-3 col-md-6 footer-col">
              ...
              <div class="d-flex flex-row">
                ...
                <div class="p-2 sub_contact_detail">
                  <a className="call_btn" href="mailto:info@stopshoprei.com">
              ...
              <div class="d-flex flex-row">
                ...
                <div class="p-2 sub_contact_detail">
                  <a
                    className="call_btn"
                    href="https://www.google.com/maps/search/?api=1&query=16+Stonefield+Drive,+Waterbury+Connecticut,+USA"
                    target="_blank"
